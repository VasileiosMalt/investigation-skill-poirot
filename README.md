<div align="center">
  ...
  <h1>"Poirot" Agent Skill</h1>
  <h1>Make your agent investigate collected material like Hercules would do</h1>
...
- Windows: `winget install ffmpeg` (or install via Chocolatey: `choco install ffmpeg`)
